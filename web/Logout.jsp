<%-- 
    Document   : Logout
    Created on : Mar 31, 2019, 1:22:59 AM
...
<center>
        ...
        <div align="center" style="opacity:1.0;" >
            <form method="post" action="MY.html">
                ...
                <tr><td width="20%"></td><td><strong><font color="black"> <b> NAME:</b></font></strong></td><td><input type="text" name="txt_uid" required></td><td width="20%"></td></tr>
                <tr><td width="20%"></td><td><strong><font color="black"><b>PASSWORD:</b></font></strong></td> <td><input type="password" name="txt_pass" required></td><td width="20%"></td></tr>
