<%-- 
    Document   : Faculty
    Created on : Mar 31, 2019, 1:14:16 AM
        ...
        <div align="center" style="opacity:1.0;" >
            <form method="post" action="validate.php">
                <table cellpadding="10" cellspacing="1" border="0" width="70%">
                    ...
                    <tr><td colspan="4" align="center"><h2><b><i>FACULTY</b></i></h2></td></tr>
                <tr><td width="20%"></td><td><strong><font color="black"> <b> NAME:</b></font></strong></td><td><input type="text" name="txt_uid"></td><td width="20%"></td></tr>
                <tr><td width="20%"></td><td><strong><font color="black"><b>PASSWORD:</b></font></strong></td> <td><input type="password" name="txt_pass"></td><td width="20%"></td></tr>
